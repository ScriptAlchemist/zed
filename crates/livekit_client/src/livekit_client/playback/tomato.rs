...
// struct SharedBuffer(
//     // TODO dvdsk: use a proper audio buffer with a send and receive side
//     Arc<Mutex<VecDeque<SamplesBuffer>>>,
// );
...
//         let samples =
//             SamplesBuffer::new(frame.num_channels as u16, frame.sample_rate.into(), samples);
